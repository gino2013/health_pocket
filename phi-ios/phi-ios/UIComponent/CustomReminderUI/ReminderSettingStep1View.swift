//
//  ReminderSettingStep1View.swift
//  phi-ios
//
...
protocol ReminderSettingStep1ViewDelegate: AnyObject {
...
@IBDesignable
class ReminderSettingStep1View: UIView, NibOwnerLoadable, UITextFieldDelegate {
    ...
    weak var delegate: ReminderSettingStep1ViewDelegate?
